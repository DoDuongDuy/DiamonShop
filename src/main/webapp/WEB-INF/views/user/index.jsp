			...
			<div class="well np">
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<div class="item">
							<img style="width: 100%"
								src="/DiamonShopcopy/assets/user/img/slide/bootstrap_free-ecommerce.png"
								alt="bootstrap ecommerce templates">
						...
						<div class="item">
							<img style="width: 100%" src="/DiamonShopcopy/assets/user/img/slide/carousel1.png"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item active">
							<img style="width: 100%" src="/DiamonShopcopy/assets/user/img/slide/carousel3.png"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item">
							<img style="width: 100%" src="/DiamonShopcopy/assets/user/img/slide/bootstrap-templates.png"
